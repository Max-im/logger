...
import {
    Box, Avatar, Paper, Typography, Divider, Button, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Chip,
} from '@mui/material';
...
const Aside: FC<IAsideProp> = ({ user, activeRoutes }) => {
    ...
    const avatarStyle = {
        width: 48, height: 48, m: '10px auto', border: '2px solid transparent', borderColor: 'info.main',
    };

    return (
        <Paper sx={{
            height: '100%', flex: '0 0 22%', position: 'sticky', top: '16px',
        }}
        >
