...
import {
    Paper, Button, Box, Typography, Chip, Divider,
} from '@mui/material';
...
import { readLogAction, ILog, LevelColors } from '../../logs';
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <Paper
                className="container"
                sx={{
                    height: 'calc(100vh - 92px)', flex: '1 1 70%', display: 'flex', flexDirection: 'column',
                }}
            >
              ...
              <Box>
                  <Chip
                      ...
                      sx={{
                          ...
                          border: `1px solid ${LevelColors[log.level].color}`,
                      }}
                  />
